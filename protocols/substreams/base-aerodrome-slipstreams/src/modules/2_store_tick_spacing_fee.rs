...
pub fn store_tick_spacing_fee(tick_spacing_fees: TickSpacingFees, store: StoreSetInt64) {
    ...
    // pre-store the factory that created the test's pools. These are the fees all three factories
    // currently charge, except that 5e7BB104 never enabled tick spacing 500.
    //
    // use hex_literal::hex;
    // let factory = hex!("f8f2eB4940CFE7d13603DDDD87f123820Fc061Ef");
